...
import { setMode } from "@/store/slices/interactionSlice";
    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Record your HCP interaction using the form or AI chat assistant
        </p>
      </div>
      ...
      <Tabs
        value={mode}
        onValueChange={(value) => dispatch(setMode(value as "form" | "chat"))}
      >
